    ...
    render() {
        return(
            <form onSubmit={this.handleFormSubmit}>
                <Col s={12}>
                    <Input id={"userName"} defaultValue={'daniel'} ref={this.usernameInput} placeholder="Username" s={12} label="Username" />
                </Col>
                <Col s={12}>
                    <Input id={"loginPassword"} defaultValue={'123'} ref={this.passwordInput} placeholder="Password" s={12} label="Password" type="password"/>
                </Col>
                <Col s={12}>
