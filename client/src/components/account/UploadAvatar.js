...
export function UploadAvatar(props) {
    ...
    return (
        <Fragment>
            ...
            {(preview && (
                <div style={{backgroundImage: `url(${preview}`}} className="avatar-preview-image overflow-hidden my-6 mx-auto block rounded-full">
                </div>
                )
            )}
            <Dropzone
			...
			<Button onClick={submitAvatar} className="btn-small right mt-4" waves="light">Submit</Button>
        </Fragment>
    )
}
